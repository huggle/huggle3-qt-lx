...
#define HUGGLE_ACCEL_MAIN_REMOVE_WHITELIST      72
#define HUGGLE_ACCEL_MAIN_REMOVE_LOW_SCORE      73
#define HUGGLE_ACCEL_MAIN_BLOCK_USER            74
...
namespace Huggle
{
    ...
    class HUGGLE_EX_CORE Configuration
    {
        public:
            ...
            bool            SystemConfig_UnsafeExts = false;
