...
bool HuggleFeedProviderIRC::Start()
{
    ...
    connect(this->network, &libircclient::Network::Event_Connected, this, &HuggleFeedProviderIRC::OnConnected);
    //connect(this->network, &libircclient::Network::Event_SelfJoin, this, &HuggleFeedProviderIRC::OnIRCSelfJoin);
    //connect(this->network, &libircclient::Network::Event_SelfPart, this, &HuggleFeedProviderIRC::OnIRCSelfPart);
    connect(this->network, &libircclient::Network::Event_PRIVMSG, this, &HuggleFeedProviderIRC::OnIRCChannelMessage);
    //connect(this->network, &libircclient::Network::Event_PerChannelQuit, this, &HuggleFeedProviderIRC::OnIRCChannelQuit);
    connect(this->network, &libircclient::Network::Event_Disconnected, this, &HuggleFeedProviderIRC::OnDisconnected);
    //connect(this->network, &libircclient::Network::Event_Join, this, &HuggleFeedProviderIRC::OnIRCUserJoin);
    //connect(this->network, &libircclient::Network::Event_Part, this, &HuggleFeedProviderIRC::OnIRCUserPart);
    connect(this->network, &libircclient::Network::Event_NetworkFailure, this, &HuggleFeedProviderIRC::OnFailure);
