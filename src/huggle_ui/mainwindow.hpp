...
namespace Huggle
{
    ...
    class HUGGLE_EX_UI MainWindow : public QMainWindow
    {
        ...
        private slots:
            ...
            void CustomWelcome(bool checked = false);
            void CustomRevert(bool checked = false);
            void CustomRevertWarn(bool checked = false);
            void CustomWarn(bool checked = false);
            ...
            void on_actionDisplay_revid_triggered();
