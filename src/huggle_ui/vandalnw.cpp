...
VandalNw::VandalNw(QWidget *parent) : QDockWidget(parent), ui(new Ui::VandalNw)
{
    ...
    this->GetChannel();
    connect(Events::Global, &Events::WikiEdit_OnGood, this, &VandalNw::OnGood);
    connect(Events::Global, &Events::WikiEdit_OnRevert, this, &VandalNw::OnRevert);
    connect(Events::Global, &Events::WikiEdit_OnSuspicious, this, &VandalNw::OnSuspicious);
    connect(Events::Global, &Events::WikiEdit_OnWarning, this, &VandalNw::OnWarning);
    connect(dynamic_cast<IRCChatTextBox*>(this->ui->plainTextEdit), &IRCChatTextBox::Event_Link, this, &VandalNw::TextEdit_anchorClicked);
    connect(this->irc, &libircclient::Network::Event_Connected, this, &VandalNw::OnConnected);
    connect(this->irc, &libircclient::Network::Event_SelfJoin, this, &VandalNw::OnIRCSelfJoin);
    connect(this->irc, &libircclient::Network::Event_SelfPart, this, &VandalNw::OnIRCSelfPart);
    connect(this->irc, &libircclient::Network::Event_PRIVMSG, this, &VandalNw::OnIRCChannelMessage);
    connect(this->irc, &libircclient::Network::Event_PerChannelQuit, this, &VandalNw::OnIRCChannelQuit);
    connect(this->irc, &libircclient::Network::Event_Disconnected, this, &VandalNw::OnDisconnected);
    connect(this->irc, &libircclient::Network::Event_Join, this, &VandalNw::OnIRCUserJoin);
    connect(this->irc, &libircclient::Network::Event_MyInfo, this, &VandalNw::OnIRCLoggedIn);
    connect(this->irc, &libircclient::Network::Event_Part, this, &VandalNw::OnIRCUserPart);
    connect(this->irc, &libircclient::Network::Event_EndOfNames, this, &VandalNw::OnIRCChannelNames);
    connect(this->irc, &libircclient::Network::Event_CTCP, this, &VandalNw::OnIRCChannelCTCP);
